...
namespace Packer
{
    class packer
    {
        ...
        static void entry()
        {
            ...
            Console.WriteLine("[*] call origin entry");
            callentry();
        }
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            newILbody.Instructions.Add(OpCodes.Call.ToInstruction(entryRef));
            newILbody.Instructions.Add(OpCodes.Ldc_I4_0.ToInstruction());
